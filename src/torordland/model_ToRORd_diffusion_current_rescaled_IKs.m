function output=model_ToRORd_diffusion_current_rescaled_IKs(t,X,flag_ode, cellType, ICaL_Multiplier, ...
...
% scaling)
GKr = 0.0321 * sqrt(ko/5) * IKr_Multiplier * 0.7; % 1st element compensates for change to ko (sqrt(5/5.4)* 0.0362)
if celltype==1
    GKr=GKr*1.3;
elseif celltype==2
    GKr=GKr*0.8;
