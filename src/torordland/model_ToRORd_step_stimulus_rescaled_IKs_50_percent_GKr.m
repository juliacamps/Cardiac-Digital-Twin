function output=model_ToRORd_step_stimulus_rescaled_IKs_60_percent_GKr(t,X,flag_ode, cellType, ICaL_Multiplier, ...
...
%% calculate the stimulus current, Istim as a step function
amp=stimAmp;
duration=stimDur;
if t<=duration
    Istim=amp;
...
GKs= 0.0011 * IKs_Multiplier * 5.0; % IKs rescaling
if celltype==1
    GKs=GKs*1.4;
end
